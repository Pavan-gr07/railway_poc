...
export default function HSR() {
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-foreground">Health Status Report (HSR)</h1>
      ...
      <div className="bg-card border border-border rounded-lg p-12 text-center">
        ...
        <h2 className="text-xl font-semibold text-foreground mb-2">Health Status Report (HSR)</h2>
